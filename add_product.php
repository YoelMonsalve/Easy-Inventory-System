               ...
               <div class="row">
                 ...
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="text" class="form-control" name="buying-price" placeholder="Ubicacion Fisica">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="saleing-price" placeholder="Destino">
                      <span class="input-group-addon"></span>
                   </div>
                  </div>
               </div>
