  ...
  if(isset($_POST['update'])) 
  {
    ...
    if( validate_fields( $req_fields ) ) {
      ...
      if($result) {
        ...
        if( verb_mode() ) print( "Failed. La Base de Datos no proceso la operacion." );
      ...
      if( verb_mode() ) print( "Failed. Problema en los campos del formulario." );
      redirect('edit_group.php?id='.(int)$e_group['id'], false);
    }
  }
  //exit();
